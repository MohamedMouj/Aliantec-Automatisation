"""
Django settings for Aliantec project.
...
SECRET_KEY = 'django-insecure-ht*twa-(6m!!20vqrbh53-)4c^z-plk^u7&y_pbk09mw45ivo#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'Aliantec' / 'template'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Aliantec.wsgi.application'
