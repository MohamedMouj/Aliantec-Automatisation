...
class UpdateTable(tables.Table):
    ...
    new_left_reference_found = tables.Column(verbose_name="New Left Ref", accessor="new_left_reference_found")
    ...
    left_source_cell = tables.Column(verbose_name="Left Source Cell", accessor="left_source_cell")
    left_distance = tables.Column(verbose_name="Left Distance", accessor="left_distance")
