class SharedData:
    ...
    def __init__(self):
        ...
        # Changed from list to dict to deduplicate shared references across XML files.
        # Each entry: { 'candidates': tuple, 'xml_paths': set() }
        self.unsured_refs = {}

        self.sured_ref = {}            # The single matched reference if only one is found
