    ...
    if request.method == 'POST' and request.FILES.get('pta_file') and request.FILES.get('zipped_fscfai'):
        ...
        if fscfai_json:
            try:
                ...
                return render(request, 'Listes_Types/Fenetrage/index.html', {
        ...
        try:
            ...
            if error:
                return render(request, 'Listes_Types/Fenetrage/index.html', {'error': error})
            ...
            return render(request, 'Listes_Types/Fenetrage/index.html', {'error': str(e)})
